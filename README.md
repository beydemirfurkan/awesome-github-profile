<p align="center">
  <img src="./assets/shared/hero.svg" alt="Awesome GitHub Profile — senior-grade README kit" width="100%" />
</p>

<h1 align="center">Awesome GitHub Profile</h1>

<p align="center">
  <strong>Production-grade GitHub profile README templates.</strong><br>
  From minimal type studies to 3D contribution skylines — copy, paste, ship.
</p>

<p align="center">
  <a href="#categories"><img src="https://img.shields.io/badge/templates-20-7c5cff?style=for-the-badge&labelColor=0b1020" alt="20 templates" /></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-MIT-00d9ff?style=for-the-badge&labelColor=0b1020" alt="MIT license" /></a>
  <a href="CONTRIBUTING.md"><img src="https://img.shields.io/badge/PRs-welcome-ff5cdb?style=for-the-badge&labelColor=0b1020" alt="contributions welcome" /></a>
</p>
  ...
  <tr>
    <td width="50%" align="center" valign="top">
      <a href="./templates/01-minimal/editorial-card/">
        <img src="./assets/previews/editorial-card.svg" alt="Editorial Card" width="100%" />
        <br><strong>Editorial Card</strong>
      </a>
      <br><sub>Magazine-style serif. No deps.</sub>
    </td>
    <td width="50%" align="center" valign="top">
      <a href="./templates/01-minimal/monospace-cv/">
        <img src="./assets/previews/monospace-cv.svg" alt="Monospace CV" width="100%" />
        <br><strong>Monospace CV</strong>
      </a>
      <br><sub>Profile as a terminal session.</sub>
    </td>
  </tr>
</table>
  ...
  <tr>
    <td width="50%" align="center" valign="top">
      <a href="./templates/03-3d-immersive/3d-contribution-tower/">
        <img src="./assets/previews/3d-contribution-tower.svg" alt="3D Contribution Tower" width="100%" />
        <br><strong>3D Contribution Tower</strong>
      </a>
      <br><sub>Your contributions as an isometric skyline.</sub>
    </td>
    <td width="50%" align="center" valign="top">
  ...
  <tr>
    <td width="50%" align="center" valign="top">
      <a href="./templates/04-gamified/snake-eat-graph/">
        <img src="./assets/previews/snake-eat-graph.svg" alt="Snake Eat Graph" width="100%" />
        <br><strong>Snake Eat Graph</strong>
      </a>
      <br><sub>The classic. Eats your contributions daily.</sub>
    </td>
    <td width="50%" align="center" valign="top">
      <a href="./templates/04-gamified/pacman-graph/">
        <img src="./assets/previews/pacman-graph.svg" alt="Pac-Man Graph" width="100%" />
        <br><strong>Pac-Man Graph</strong>
      </a>
      <br><sub>The louder cousin. Ghosts included.</sub>
    </td>
  </tr>
</table>
  ...
  <tr>
    ...
    <td width="50%" align="center" valign="top">
      <a href="./templates/05-dashboard/activity-pulse/">
        <img src="./assets/previews/activity-pulse.svg" alt="Activity Pulse" width="100%" />
        <br><strong>Activity Pulse</strong>
      </a>
      <br><sub>One card. Lots of signal. metrics-engine.</sub>
    </td>
  </tr>
</table>
  ...
  <tr>
    ...
    <td width="50%" align="center" valign="top">
      <a href="./templates/06-designer-portfolio/editorial-magazine/">
        <img src="./assets/previews/editorial-magazine.svg" alt="Editorial Magazine" width="100%" />
        <br><strong>Editorial Magazine</strong>
      </a>
      <br><sub>Typeset like a small print quarterly.</sub>
    </td>
  </tr>
</table>
  ...
  <tr>
    <td width="50%" align="center" valign="top">
      <a href="./templates/08-markdown-tricks/light-dark-switcher/">
        <img src="./assets/previews/light-dark-switcher.svg" alt="Light/Dark Switcher" width="100%" />
        <br><strong>Light / Dark Switcher</strong>
      </a>
      <br><sub>One <code>&lt;picture&gt;</code> tag, perfect parity.</sub>
    </td>
    <td width="50%" align="center" valign="top">
      <a href="./templates/08-markdown-tricks/collapsible-projects/">
        <img src="./assets/previews/collapsible-projects.svg" alt="Collapsible Projects" width="100%" />
        <br><strong>Collapsible Projects</strong>
      </a>
      <br><sub>Pack ten projects into the space of three.</sub>
    </td>
  </tr>
</table>
  ...
  <tr>
    <td width="50%" align="center" valign="top">
      <a href="./templates/09-avant-garde/aurora-veil/">
        <img src="./assets/previews/aurora-veil.svg" alt="Aurora Veil" width="100%" />
        <br><strong>Aurora Veil</strong>
      </a>
      <br><sub>Multi-layer turbulence + displacement, never repeats.</sub>
    </td>
    <td width="50%" align="center" valign="top">
      <a href="./templates/09-avant-garde/holographic-foil/">
        <img src="./assets/previews/holographic-foil.svg" alt="Holographic Foil" width="100%" />
        <br><strong>Holographic Foil</strong>
      </a>
      <br><sub>Pokemon 1st-edition card, animated stop-color iridescence.</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center" valign="top">
      <a href="./templates/09-avant-garde/liquid-morph-wordmark/">
        <img src="./assets/previews/liquid-morph-wordmark.svg" alt="Liquid Morph Wordmark" width="100%" />
        <br><strong>Liquid Morph Wordmark</strong>
      </a>
      <br><sub>Path interpolation across six geometric forms.</sub>
    </td>
    <td width="50%" align="center" valign="top">
      <a href="./templates/09-avant-garde/neural-pulse-lattice/">
        <img src="./assets/previews/neural-pulse-lattice.svg" alt="Neural Pulse Lattice" width="100%" />
        <br><strong>Neural Pulse Lattice</strong>
      </a>
      <br><sub>10 nodes, 15 edges, 9 signals — animateMotion + mpath.</sub>
    </td>
  </tr>
</table>
